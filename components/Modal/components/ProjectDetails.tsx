...
export const ProjectMetrics = memo(
...
export const AwardItem = memo(({ award }: { award: string }) => (
...
export const ProjectRecognition = memo(
...
export const TechnologyTag = memo(({ tech }: { tech: string }) => (
